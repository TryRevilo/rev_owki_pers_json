...
Java_rev_ca_rev_1gen_1lib_1pers_c_1libs_1core_RevPersMathLibFunctionSets_stringFromJNI(JNIEnv *env,
                                                                                       jobject thiz) {
    ...
    //              PRIu64, ticks);
    // __android_log_print(ANDROID_LOG_ERROR, "MyApp", "calculation time: %" PRIu64, ticks);
